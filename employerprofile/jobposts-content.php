    ...
    <div style="display: flex; flex-direction: column; gap: 18px;">
        ...
        if ($employer_id > 0) {
            ...
            if (isset($conn) && $conn->ping()) {
                ...
                $sql = "SELECT id, company_logo, created_at, post_duration, salary, company_name, job_title, job_location FROM job WHERE posted_by_employer_id = ?";
            ...
            <?php endwhile;
                ...
                echo '<div style="color: #888;">Database connection error or no employer ID.</div>';
            }
        } else {
